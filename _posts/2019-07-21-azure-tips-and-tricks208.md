---
layout: post
title: "Azure Tips and Tricks Part 208 - Set up a MEAN-based web application on a new Azure Linux virtual machine"
excerpt: "Learn how to use set up a mean-based web application on a new azure linux virtual machine"
...
The post you are looking for is [here](https://microsoft.github.io/AzureTipsAndTricks/blog/tip208.html) All future Azure Tips and Tricks will be located on [the new site](http://azuredev.tips/).
