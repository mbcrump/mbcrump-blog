...
<img style="border:3px solid #021a40" src="/files/dockerblog1.png">
...
Nice! The only thing left to do now is push it to Azure using [Web App for Containers](https://azure.microsoft.com/en-us/services/app-service/containers/) which we'll do tomorrow. 
